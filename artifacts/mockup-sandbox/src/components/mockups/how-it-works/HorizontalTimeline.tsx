...
const steps = [
  { title: 'Pick a task', detail: 'From JIRA or Azure DevOps. All incomplete epics, stories, and bugs in one prioritised view.' },
  ...
  { title: 'Four agents generate code', detail: 'Claude, GPT-4o, Anti Gravity, and MS Copilot write solutions simultaneously in parallel.' },
  { title: 'Agents debate & critique', detail: 'Structured peer review. Each solution scored on correctness, readability, and convention adherence.' },
  { title: 'Developer reviews diffs', detail: 'Four tabs. One recommended. Plain-English explanation of why it was ranked first.' },
    ...
    <div style={{ background: 'var(--bg-app)', minHeight: '100vh', padding: '64px 48px', fontFamily: 'var(--font-sans)', boxSizing: 'border-box' }}>
      ...
      >
        ...
        <span style={{
          ...
          position: 'absolute', top: -20, right: 32, lineHeight: 1, userSelect: 'none',
          pointerEvents: 'none',
        }}>{active + 1}</span>
      ...
      <div style={{ display: 'flex', gap: 20, marginTop: 24 }}>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'var(--font-serif)', fontWeight: 700, fontStyle: 'italic', fontSize: 18, color: 'var(--text-primary)', lineHeight: 1.4 }}>
            "The developer made one decision."
          </div>
          <div style={{ fontFamily: 'var(--font-serif)', fontWeight: 700, fontStyle: 'italic', fontSize: 18, color: 'var(--accent-blue)', lineHeight: 1.4, marginTop: 4 }}>
